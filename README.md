...
# ✨ Muhammad Ahadiyas Hatumena ✨

<p><em>Hi there 👋 My name is Muhammad Ahadiyas Hatumena. I am a Software Engineer hand-on Full-stack Website Developer and live in South Jakarta, Indonesia, I focus on website and application development. My hobby in IT is likes about new things about coding.</em></p>
...
`React` • `Vue.js` • `CSS3` • `Next.js` • `Tailwind` • `HTML5` • `Bootstrap`

**⚙️ Backend**

`Node.js` • `PostgreSQL` • `MySQL` • `Laravel`
...
<a href="https://www.linkedin.com/in/m-ahadiyas-hatumena/"><img src="https://img.shields.io/badge/linkedin-%230077B5.svg?style=for-the-badge&logo=linkedin&logoColor=white"></a> 
